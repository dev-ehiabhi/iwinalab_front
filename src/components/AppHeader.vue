				...
				>
					...
					>
						...
						<button
							...
							class="inline-flex cursor-pointer items-center gap-2 whitespace-nowrap rounded-lg tracking-wide transition hover:opacity-75 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
							:class="
								dropdown_status
									? 'text-gray-800 dark:text-amber-100'
									: 'text-neutral-700 dark:text-neutral-200'
							"
							:aria-expanded="dropdown_status"
							aria-haspopup="true"
						>
							Solutions
							<svg
						...
						<!-- Dropdown Menu -->
						<div
							v-show="dropdown_status"
							class="absolute top-11 flex w-full min-w-[32rem] flex-col divide-y divide-neutral-300 overflow-visible rounded-lg bg-gray-100 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40 dark:divide-gray-900 dark:bg-gray-800 z-10"
							role="menu"
						>
							<!-- Dropdown Section -->
							<div class="py-1">
								<p
									class="gap-2 px-6 py-2 text-sm text-neutral-700"
									role="menuitem"
								>
									Solutions
								</p>
							...
							<div class="flex flex-col justify-between py-1.5">
								<div class="w-full flex justify-between">
									<a
										href="#"
										class="w-1/2 flex flex-grow items-center gap-2 px-4 py-2 text-sm text-neutral-700 hover:bg-gray-800/5 hover:text-gray-800 focus-visible:bg-gray-800/10 focus-visible:text-gray-800 focus-visible:outline-none dark:bg-gray-800 dark:text-neutral-200 dark:hover:bg-gray-50/5 dark:hover:text-amber-100 dark:focus-visible:bg-gray-50/10 dark:focus-visible:text-amber-100"
										role="menuitem"
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
									...
									<a
										href="#"
										class="w-1/2 flex flex-grow items-center whitespace-nowrap gap-2 px-4 py-2 text-sm text-neutral-700 hover:bg-gray-800/5 hover:text-gray-800 focus-visible:bg-gray-800/10 focus-visible:text-gray-800 focus-visible:outline-none dark:bg-gray-800 dark:text-neutral-200 dark:hover:bg-gray-50/5 dark:hover:text-amber-100 dark:focus-visible:bg-gray-50/10 dark:focus-visible:text-amber-100"
										role="menuitem"
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
