...
<template>
    <aside class="flex flex-col h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
        <a href="#">
            <img class="w-auto h-7" :src="logo" alt="Iwina Logo">
        </a>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav class="flex-1 -mx-3 space-y-3 ">
                ...
                <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <RouterLink to="/home" class="mx-2 text-sm font-medium">Home</RouterLink>
                </a>
                ...
                <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <RouterLink to="/dashboard" class="mx-2 text-sm font-medium">Dashboard</RouterLink>
                </a>
                ...
                <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <RouterLink to="/profile" class="mx-2 text-sm font-medium">Profile</RouterLink>
                </a>
                ...
                <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <RouterLink to="/products" class="mx-2 text-sm font-medium">Products</RouterLink>
                </a>
