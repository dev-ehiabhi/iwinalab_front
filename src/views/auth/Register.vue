        ...
        <div class="w-1/2 flex-grow">
            <div class="rounded-lg dark:bg-gray-800">
                <div class="px-12 pt-8">
                    ...
                    <h3 class="mt-3 text-xl font-medium text-gray-600 dark:text-gray-200">Sign Up to create account</h3>

                    <p class="mt-1 text-gray-500 dark:text-gray-400">Enter credentials to an create account</p>

                    <div class="flex py-4 overflow-x-auto whitespace-nowrap">
                        <button @click="changeRegisterToggle(true)" :class="[register_toggle ? 'border border-b-0 border-gray-300 bg-gray-200' : 'border-b border-gray-300']" class="inline-flex items-center h-12 px-4 py-2 text-sm text-center text-gray-700 sm:text-base dark:border-gray-500 rounded-t-md dark:text-white whitespace-nowrap focus:outline-none hover:border-gray-400 dark:hover:border-gray-300">
                            Farmer
                        </button>

                        <button @click="changeRegisterToggle(false)" :class="[register_toggle ? 'border-b border-gray-300' : 'border border-b-0 border-gray-300 bg-gray-200 rounded-t-md']" class="inline-flex items-center h-12 px-4 py-2 text-sm text-center text-gray-700 sm:text-base dark:border-gray-500 dark:text-white whitespace-nowrap cursor-base focus:outline-none hover:border-gray-400 dark:hover:border-gray-300">
                            Organization
                        </button>
