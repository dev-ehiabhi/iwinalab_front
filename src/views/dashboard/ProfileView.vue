...
<template>
	<section class="p-6 bg-gray-100 text-gray-900">
		...
		<article
			class="p-6 mx-auto bg-gray-50 rounded-md shadow-md dark:bg-gray-800"
		>
			<h2
			...
			<form>
				...
				<div class="flex justify-end mt-6">
					<button
						class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-lime-700 rounded-md hover:bg-lime-600 focus:outline-none focus:bg-lime-600"
					>
						Save
					</button>
				</div>
